...
public class BGAStickyNavLayout extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        if (getChildCount() != 3) {
            throw new IllegalStateException(cn.bingoogolapple.refreshlayout.BGAStickyNavLayout.class.getSimpleName() + "必须有且只有三个子控件");
        }
    ...
    private void regetNestedContentView() {
        ...
        if (adapter instanceof FragmentPagerAdapter || adapter instanceof FragmentStatePagerAdapter) {
            ...
            throw new IllegalStateException(cn.bingoogolapple.refreshlayout.BGAStickyNavLayout.class.getSimpleName() + "的第三个子控件为ViewPager时，其adapter必须是FragmentPagerAdapter或者FragmentStatePagerAdapter");
        }
    }
